...
class AlienInvasion:
    #manages assets and game behaviour

    def __init__(self):
        #starts the game and creates resources
        pygame.init()
    ...
    def _check_bullet_alien_collisions(self):
            ...
            #Remove bullets that have colided
    ...
    #Update the positions of all aliens in the fleet
        ...
        #Look for alien to ship colisions
